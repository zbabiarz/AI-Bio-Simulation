  ...
  return (
    <div className="max-w-4xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">AI Bio-Coach</h1>
        ...
        {messages.length > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-slate-400 hover:text-red-400 transition-colors"
          >
        ...
        <form onSubmit={handleSubmit} className="p-4 border-t border-slate-700">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-slate-900/50 border border-slate-600 rounded-lg py-3 px-4 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
              disabled={loading}
            />
            <button
              type="submit"
              disabled={loading || !input.trim()}
              className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex gap-2 mt-3 flex-wrap">
            {suggestedQuestions.slice(0, 3).map((question) => (
              <button
                ...
                className="px-2 py-1 bg-slate-700/30 hover:bg-slate-700/50 text-slate-400 text-xs rounded transition-colors flex items-center gap-1"
              >
